...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring(open('/uscms/home/aacharya/nobackup/CMSSW_10_6_20/src/GEN_list.txt').readlines()),
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:sim_10kevents.root')
)
